<template>
  <div>
    <div
      id="dsg-lc-missing-828-de"
      class="dsg-lc-missing dsg-lc-missing2 dsg-license-content-info-shop"
    >
      <div class="title">
        Bitte erwerben Sie die passende Lizenz, um alle Module für das Dokument
        <strong>"Datenschutzerklärung"</strong> freizuschalten:
      </div>
      <div class="infos-shop-inwk-label-de">Deutschsprachige Lizenz:</div>
      <div class="info-shop-inwk-de">
        <p class="product woocommerce add_to_cart_inline" style="">
          <span class="woocommerce-Price-amount amount"
            ><bdi
              >99,90&nbsp;<span class="woocommerce-Price-currencySymbol"
                >€</span
              ></bdi
            ></span
          ><a
            href="?add-to-cart=2004"
            data-quantity="1"
            class="button product_type_license_key add_to_cart_button ajax_add_to_cart"
            data-product_id="2004"
            data-product_sku="ppde"
            aria-label="„Datenschutzerklärung Deutsch“ zu Ihrem Warenkorb hinzufügen"
            rel="nofollow"
            target="_blank"
            >In den Warenkorb</a
          >
      ...
      <div class="infos-shop-inwk-label-en">Englischsprachige Lizenz:</div>
      <div class="info-shop-inwk-en">
        <p class="product woocommerce add_to_cart_inline" style="">
          <span class="woocommerce-Price-amount amount"
            ><bdi
              >129,90&nbsp;<span class="woocommerce-Price-currencySymbol"
                >€</span
              ></bdi
            ></span
          ><a
            href="?add-to-cart=2349"
            data-quantity="1"
            class="button product_type_license_key add_to_cart_button ajax_add_to_cart"
            data-product_id="2349"
            data-product_sku="ppen"
            aria-label="„Datenschutzerklärung Englisch (Privacy Policy)“ zu Ihrem Warenkorb hinzufügen"
            rel="nofollow"
            target="_blank"
            >In den Warenkorb</a
          >
      ...
      <div class="info-shop-extrainfo">
        *Nur für Geschäftskunden, netto,
        <a
          href="https://datenschutz-generator.de/produkt-kategorie/datenschutzerklaerung/"
          target="shop"
          title="Produkt im Shop aufrufen (öffnet sich im neuen Tab/Fenster Ihres Browsers)"
          >Informationen zu Lizenzen und Mengenrabatten</a
        >
        (z. B. Deutsch + Englisch 30 € Rabatt, wird im WK berechnet).
      </div>
      <div class="info-shop-lctrue">
        Nach dem Erwerb erhalten Sie einen Lizenzschlüssel per E-Mail, den Sie
        <a
          title="Lizenzschlüssel im Premiumbereich eingeben."
          href="#dsg-group-premium"
          >oben im Premiumbereich eingeben</a
        >
        und damit die Module freischalten können. (<a
          href="https://datenschutz-generator.de/help-premium/"
          target="help-license"
          title="Anleitung für den Lizenzerwerb (öffnet sich im neuen Tab/Fenster Ihres Browsers)"
          >Anleitung</a
        >).
      </div>
    </div>
    ...
    <ul class="m-elements">
      ...
      <li>
        ...
        Online-Formular), Sicherheitsmaßnahmen, Verwaltung und Beantwortung von
        Anfragen.
      </li>
      <li>
    ...
    <p>
      ...
      Fall von Bestandskundenwerbung, erlaubt ist. Soweit wir einen
      Dienstleister mit dem Versand von E-Mails beauftragen, geschieht dies auf
      der Grundlage unserer berechtigten Interessen. Das Registrierungsverfahren
    ...
    <p>
      ...
      Die Auswertungen dienen uns vielmehr dazu, die Lesegewohnheiten unserer
    ...
    <p>
      ...
      vorbehaltlich einer ausdrücklichen Einwilligung der Nutzer, auf Grundlage
      unserer berechtigten Interessen zu Zwecken des Einsatzes eines
    ...
    <p>
      <strong>Versand via SMS</strong>: Die elektronischen Benachrichtigungen
      können ebenfalls als SMS-Textnachrichten versenden werden (bzw. werden
    ...
    <p>
      ...
      Fall, wenn die Nutzer z.B. Mitglieder eines sozialen Netzwerks sind,
      dessen Onlinemarketingverfahren wir einsetzen und das Netzwerk die Profile
      der Nutzer mit den vorgenannten Angaben verbindet. Wir bitten darum, zu
    ...
    <ul class="m-elements">
      ...
      <li>
        ...
        Marketingmaßnahmen), Interessenbasiertes und verhaltensbezogenes
        Marketing, Profiling (Erstellen von Nutzerprofilen), Reichweitenmessung
      ...
      <li>
        <strong>Widerspruchsmöglichkeit (Opt-Out):</strong> Wir verweisen auf
    ...
    <p>
      <strong>Facebook</strong>: Wir sind gemeinsam mit Facebook Irland Ltd. für
    ...
    <ul class="m-elements">
      ...
      <li>
        ...
        Protokolldateien mit solchen Daten für 30 Tage, um die monatliche Anzahl
        der Seitenaufrufe zu ermitteln, gespeichert; Nach einer solchen
